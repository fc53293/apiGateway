...
<body>
  ...
  <div class="banner-image w-100 vh-100 d-flex justify-content-center align-items-center">
    <div class="content text-center">
      ...
      <form action="#">
        <button type="button" class="mt-1 mb-4 btn btn-light btn-host"><i class="fas fa-key p-1"></i>Became a Host</button>
        <div class="form-floating mb-4">
          ...
          <div class="form-floating">
            ...
            <button type="submit" class="m-5 btn btn-primary btn-lg btn-block">Sign Up</button>
          </div>
      </form>
    </div>
  </div>
