<head>
  ...
  <link rel="stylesheet" href="./CSS/styleAPI.scss">
...
<body>
  ...
  <div class="banner-image w-100 vh-100 d-flex justify-content-center align-items-center">
    <div class="content text-center">
      ...
      <form action="{{url('/createSenhorio') }}" method="POST" id="formRegistar">
      <div class=""><h2>Senhorio</h2></div>
        <div class="">
          ...
          <button type="button" class="mt-1 mb-4 btn btn-host" onclick="confirmation();">Submit</button>
        </div>
      </form>
...
<style>
h2 { color: rgb(19 82 139); font-family: 'Raleway',sans-serif; font-size: 30px; font-weight: 800; line-height: 36px; margin: 0 0 24px; text-align: center; }
